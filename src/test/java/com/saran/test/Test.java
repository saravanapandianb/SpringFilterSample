...
import com.saran.utils.StringUtils;

public class Test {

    public static void main(String[] args) throws Exception {
        String key = "Duc@nt";
        String clean = "{\"message\":\"test welcome\"}";
        
        byte[] encrypted = encrypt(clean, key);
        String encryptedString = "179asukip0pud1l6oic3ty0ls7ci1z5cjzbf2oew52iexzcho6otcpjrs22sivgg28ncln4lw7pf4wkmxdw5rqqocsf1vkweuaw2";//StringUtils.bytesToString(encrypted);
//        System.out.println(encryptedString);
        String decrypted = decrypt(encrypted, key);
        
        decrypted = decrypt(encryptedString, key);
